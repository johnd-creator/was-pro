...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'Verifikasi dua langkah sudah aktif. Pindai kode QR atau masukkan kunci setup ke aplikasi autentikator Anda.',
            buttonText: 'Tutup',
        };
    }
    ...
    return {
        ...
        description:
            'Untuk menyelesaikan aktivasi, pindai kode QR atau masukkan kunci setup ke aplikasi autentikator Anda',
        buttonText: 'Lanjutkan',
    };
});
