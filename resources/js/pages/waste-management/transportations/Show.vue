...
<template>
    ...
    >
        <Head
            :title="`${wasteTransportation.transportation_number} - Transportasi Limbah`"
        />

        <div
            class="relative mx-auto w-full max-w-7xl overflow-x-hidden px-4 py-5 sm:px-6 sm:py-6 lg:px-8 lg:py-8"
        >
            <div
            ...
            <div class="space-y-8">
                <section class="space-y-4">
                    ...
                    <div
                        class="flex flex-col gap-4 rounded-[30px] border border-slate-200 bg-gradient-to-br from-white via-slate-50/80 to-blue-50/20 p-6 shadow-[0_24px_60px_-36px_rgba(15,23,42,0.35)] lg:flex-row lg:items-start lg:justify-between dark:border-slate-800"
                    >
                        <div class="space-y-2">
                            <p
                            ...
                            <h1
                                class="text-3xl font-semibold tracking-tight text-slate-950 dark:text-slate-100"
                            >
                            ...
                            <p class="max-w-2xl text-sm text-muted-foreground">
                                ...
                                }}. Halaman ini merangkum informasi pengiriman,
                                catatan limbah terkait, dan vendor tujuan dalam
                                satu tampilan.
                            </p>
                        </div>
                    ...
                    <div class="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
                        <div
                            ...
                            :key="fact.label"
                            class="rounded-[24px] border p-4 shadow-[0_18px_40px_-28px_rgba(15,23,42,0.28)]"
                            :class="fact.tone"
                        >
                            <div class="flex items-start justify-between gap-3">
                                <div>
                                    <p
                                        class="text-[11px] font-semibold tracking-wide uppercase opacity-80"
                                    >
                                        {{ fact.label }}
                                    </p>
                                    <p
                                        class="mt-2 text-sm leading-5 font-semibold text-slate-900 dark:text-slate-100"
                                    >
                                        {{ fact.value }}
                                    </p>
                                </div>
                    ...
                    <div class="flex items-end justify-between gap-4">
                        <div>
                            ...
                            >
                                ...
                                Rincian pengiriman dan jejak status
                            </h3>
                        </div>
                    </div>
                    ...
                    <div class="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
                        ...
                        >
                            <CardHeader class="pb-4">
                                ...
                                <CardDescription>
                                    Informasi inti pengiriman yang paling sering
                                    dicek saat operasional.
                                </CardDescription>
                            </CardHeader>
                            <CardContent class="space-y-6">
                                <div class="grid gap-4 md:grid-cols-2">
                                    <div
                                        class="rounded-2xl border border-slate-100 bg-slate-50/80 p-4 dark:bg-slate-900/70"
                                    >
                                        <div
                                            class="mb-3 flex items-center gap-2 text-slate-700 dark:text-slate-200"
                                        >
                                ...
                                >
                                    <div
                                        ...
                                        class="rounded-2xl border border-slate-100 bg-white p-4 dark:bg-slate-950"
                                    >
                                        <div
                                            class="mb-3 flex items-center gap-2 text-slate-700 dark:text-slate-200"
                                        >
                        ...
                        <div class="space-y-6">
                            ...
                            >
                                <CardHeader class="pb-4">
                                    <CardTitle
                                        >Catatan Limbah Terkait</CardTitle
                                    >
                                    <CardDescription>
                                        Sumber limbah yang diangkut pada
                                        transportasi ini.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent class="space-y-4">
                            ...
                            >
                                <CardHeader class="pb-4">
                                    ...
                                    <CardDescription>
                                        Informasi mitra pengangkutan atau
                                        penerima limbah.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent class="space-y-4">
                                    ...
                                    <div
                                        v-if="wasteTransportation.vendor?.phone"
                                    >
                                        <p class="text-sm font-medium">
                                            Telepon
                                        </p>
                                    ...
                                    <div
                                        v-if="wasteTransportation.vendor?.email"
                                    >
                ...
                >
                    <CardHeader class="pb-4">
                        ...
                        <CardDescription>
                            Jejak perubahan status transportasi dari awal hingga
                            kondisi saat ini.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
