...
import { DownloadIcon, FileText, RotateCcw, Search } from 'lucide-vue-next';
    ...
    >
        ...
        <div class="space-y-6 p-6">
            ...
            <div class="grid gap-4 md:grid-cols-3">
                <div class="rounded-xl border bg-card p-4">
                    ...
                    <p class="mt-1 text-xs text-muted-foreground">
                        Seluruh catatan limbah yang tercatat saat ini.
                    </p>
                </div>
                <div class="rounded-xl border bg-card p-4">
                    ...
                    <p class="mt-1 text-xs text-muted-foreground">
                        {{ totalDraftRecords }} masih dalam draf dan belum
                        diajukan.
                    </p>
                </div>
                <div class="rounded-xl border bg-card p-4">
                    ...
                    <p class="mt-1 text-xs text-muted-foreground">
                        Gunakan filter masa simpan untuk fokus pada catatan
                        berisiko.
                    </p>
                </div>
            </div>
            ...
            >
                ...
                <Select v-model="expiryFilter" @update:model-value="resetPage">
                    <SelectTrigger>
                    ...
                    <SelectContent>
                        ...
                        >
                        <SelectItem value="fresh">Masih aman</SelectItem>
                    </SelectContent>
                </Select>
                    ...
                    <TableBody>
                        ...
                        >
                            ...
                            <TableCell>
                                <div class="space-y-1">
                                    <span
                                        v-if="record.waste_type?.category"
                                    ...
                                    <p class="text-xs text-muted-foreground">
                                        {{
                                            record.waste_type?.characteristic
                                                ?.is_hazardous
                            ...
                            <TableCell>
                                {{
                                    parseFloat(String(record.quantity)).toFixed(
                                        2,
                                    )
                                }}
                                {{ record.unit }}
