...
class PermissionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'View FABA Adjustments', 'slug' => 'faba_adjustments.view', 'module' => 'faba_adjustments', 'description' => 'View FABA adjustments'],
            ['name' => 'Create FABA Adjustments', 'slug' => 'faba_adjustments.create', 'module' => 'faba_adjustments', 'description' => 'Create FABA adjustments'],
            ['name' => 'Edit FABA Adjustments', 'slug' => 'faba_adjustments.edit', 'module' => 'faba_adjustments', 'description' => 'Edit FABA adjustments'],
            ['name' => 'Delete FABA Adjustments', 'slug' => 'faba_adjustments.delete', 'module' => 'faba_adjustments', 'description' => 'Delete FABA adjustments'],
